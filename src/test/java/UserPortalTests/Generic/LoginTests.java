...
public class LoginTests extends GlobalSetup {
     ...
     */
    String loginTestData = "TestData/Data/MaradimData/Roles.json";
    ...
    public void testSupervisorValidLogin() {
        boolean greetingMSG =
                loginPage.setUserName(getJson(loginTestData, "supervisor","supervisorUsername"))
                        .setPassword(getJson(loginTestData, "supervisor","supervisorPassword"))
                        .clickLoginBtn()
                        .getGreeting(getJson(loginTestData, "supervisor","supervisorName"));
        Assert.assertTrue(greetingMSG, "Login Failed");
    }
